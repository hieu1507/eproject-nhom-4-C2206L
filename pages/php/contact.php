    ...
    <div class="container">
        <form method="post">
            <div class="form">
                ...
                <input required="true" type="text" class="form-control" name="contact-name" value="">
                <div class="mess">Please add your name</div>
            </div>
            <div class="form">
                <label for="contact-email">Email *</label><br>
                <input required="true" type="email" class="form-control" name="contact-email" value="">
                <div class="mess">Please add your email</div>
            </div>
            <div class="form">
                <label for="contact-subject">Subject</label><br>
                <select name="contact-subject" class="form-control">
                    <option value="general information">General Information</option>
                    <option value="jenkinson">Jenkinson's South HR</option>
                    <option value="aquarium">Aquarium</option>
                    <option value="website">Website</option>
                    <option value="other">Other</option>
                </select>
                <div class="mess">Please select a subject for your contact submission</div>
            </div>
            <div class="form">
                <label for="contact-comment">Comment *</label><br>
                <input required="true" type="text" class="form-control0" name="contact-comment" value="">
                <div class="mess">Please add any comments or details for your contact submission. Please do not include any confidential or personal information.</div>
            </div>
