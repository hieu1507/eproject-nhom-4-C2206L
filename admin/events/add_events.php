          ...
          <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                ...
                <form action="pr_add_events.php" method="POST" enctype="multipart/form-data">
                      <div class="mb-3">
                        <label >Event Title</label>
                        <input required name="ev_title" type="text" class="form-control" placeholder="Enter Event Title">
                      </div>
                      <div class="mb-3">
                        <label >Start Event</label>
                        <input required name="ev_start" type="date" class="form-control" >
                      </div>
                      <div class="mb-3">
                        <label >End Event</label>
                        <input required name="ev_end" type="date" class="form-control" >
                      </div>
                      <div class="mb-3">
