            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                ...
                <form action="pr_edit_animal.php" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="mb-3">
                        <label >Name</label>
                        <input required name="name" type="text" class="form-control" placeholder="Enter Name" value="<?=$item['name_animal']?>">
                      </div>
                     <div class="mb-3">
                      <label >Service</label>
                      ...
                      <div class="mb-3">
                        ...
                        <input required name="quantity" type="text" class="form-control" placeholder="Enter Quantity" value="<?=$item['quantity_animal']?>">
                      </div>
                      <div class="mb-3">
                        <label >Price</label>
                        <input required name="price" type="text" class="form-control" placeholder="Enter Price" value="<?=$item['price_animal']?>">
                      </div>
                      <div class="mb-3">
