...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <div id="wrapper">
        ...
        $sql = "select * from mn_product where id_mn_product = " . $_GET['id_mn_product'];
              ...
              <div class="card-body">
                ...
                <form action="pr_edit_mn_product.php" method="POST" enctype="multipart/form-data">
                      <div class="mb-3">
                        ...
                        <input readonly name="id_mn_product" type="text" class="form-control" value="<?=$item['id_mn_product']?>">
                      </div>
                      <div class="mb-3">
